...
const config = {
  ...
  GOOGLE_CALENDAR_CALLBACK_URL: process.env.GOOGLE_CALENDAR_CALLBACK_URL || process.env.GOOGLE_CALLBACK_URL?.replace('/auth/google/callback', '/auth/google/calendar/callback'),
