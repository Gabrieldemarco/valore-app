    ...
    <div className="auth-body">
      <div className="auth-card glass-panel">
        ...
        {!sent && (
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} className="glass-input" required placeholder="tucorreo@ejemplo.com" />
            </div>
        ...
        <div className="auth-back-link">
          <Link to="/client/login">← Volver al inicio de sesión</Link>
        </div>
      </div>
    </div>
  );
