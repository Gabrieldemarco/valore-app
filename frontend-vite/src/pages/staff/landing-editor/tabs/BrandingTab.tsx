    ...
    <div className="card glass-panel p-24">
      ...
      <div className="card-base mb-24">
        ...
        <div className="form-group">
          ...
          <select className="glass-input cursor-pointer px-12 py-10"
        ...
        <div className="form-group m-0">
          ...
          <select className="glass-input cursor-pointer px-12 py-10"
            ...
            <small className="text-muted block mt-6">
      ...
      <div className="card-base mb-24">
        ...
        <small className="text-muted block mt-8 text-sm-2">{t('staffLandingEditor.quickThemeHint')}</small>
      </div>
        ...
        <div className="form-group">
          ...
          <div className="flex-center flex-gap-8">
            {!!tenant.brand_logo_url && (
              <img src={fixImageUrl(tenant.brand_logo_url as string)} alt={t('brandingTab.altLogo')} className="w-36 h-36 object-cover-6" onError={e => { (e.target as HTMLImageElement).style.display = 'none'; }} />
            )}
          ...
          <input type="file" accept="image/*" className="glass-input mt-5 p-10"
        ...
        <div className="form-group m-0">
          ...
          <div className="flex-center flex-gap-8">
            {!!tenant.landing_hero_image && (
              <img src={fixImageUrl(tenant.landing_hero_image as string)} alt={t('brandingTab.altHero')} className="w-36 h-36 object-cover-6" onError={e => { (e.target as HTMLImageElement).style.display = 'none'; }} />
            )}
            <input type="url" className="glass-input flex-1" placeholder="https://..."
